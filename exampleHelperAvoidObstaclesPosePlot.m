function exampleHelperAvoidObstaclesPosePlot(u, mapMatrix, mapScale, range, scanAngles, ax)
...
xCoord = u(1);
yCoord = u(2);  
scatter(xCoord, yCoord, 'filled', 'MarkerEdgeColor', 'r', 'MarkerFaceColor', 'r');
robotPath = [robotPath; xCoord, yCoord]; 
hold(ax, "off");
drawnow;